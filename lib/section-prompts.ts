...
export const SECTION_CONFIGS: SectionConfig[] = [
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    requiredRows: [
      // NOTE: row_key must be 'total_revenue' — all UI components reference this key
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    requiredRows: [
      ...
      { rowKey: 'total_mgmt_adjustments', label: 'Total Management Adjustments', valueType: 'currency', isCalculated: true },
      { rowKey: 'mgmt_adjusted_ebitda', label: 'Management-Adjusted EBITDA', valueType: 'currency', isCalculated: true },
      ...
      { rowKey: 'total_diligence_adjustments', label: 'Total Diligence Adjustments', valueType: 'currency', isCalculated: true },
      { rowKey: 'diligence_adjusted_ebitda', label: 'Diligence-Adjusted EBITDA', valueType: 'currency', isCalculated: true },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    requiredRows: [
      ...
      { rowKey: 'net_product_sales', label: 'Net Product Sales', valueType: 'currency', isCalculated: true },
      ...
      { rowKey: 'total_net_revenue', label: 'Total Net Revenue', valueType: 'currency', isCalculated: true },
      ...
      { rowKey: 'total_cogs', label: 'Total Cost of Goods Sold', valueType: 'currency', isCalculated: true },
      { rowKey: 'gross_profit', label: 'Gross Profit', valueType: 'currency', isCalculated: true },
      ...
      { rowKey: 'total_operating_expenses', label: 'Total Operating Expenses', valueType: 'currency', isCalculated: true },
      { rowKey: 'operating_income_ebitda', label: 'Operating Income (EBITDA)', valueType: 'currency', isCalculated: true },
      { rowKey: 'interest_expense', label: 'Interest Expense', valueType: 'currency', isCalculated: false },
      { rowKey: 'depreciation_amortization', label: 'Depreciation & Amortization', valueType: 'currency', isCalculated: false },
      { rowKey: 'income_before_tax', label: 'Income Before Tax', valueType: 'currency', isCalculated: true },
      { rowKey: 'tax_provision', label: 'Tax Provision', valueType: 'currency', isCalculated: false },
      { rowKey: 'net_income', label: 'Net Income', valueType: 'currency', isCalculated: true },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    requiredRows: [
      ...
      { rowKey: 'net_accounts_receivable', label: 'Net Accounts Receivable', valueType: 'currency', isCalculated: true },
      ...
      { rowKey: 'total_inventory', label: 'Total Inventory', valueType: 'currency', isCalculated: true },
      ...
      { rowKey: 'total_current_assets', label: 'Total Current Assets', valueType: 'currency', isCalculated: true },
      ...
      { rowKey: 'net_fixed_assets', label: 'Net Fixed Assets', valueType: 'currency', isCalculated: true },
      { rowKey: 'intangible_assets', label: 'Intangible Assets - Software', valueType: 'currency', isCalculated: false },
      { rowKey: 'total_assets', label: 'Total Assets', valueType: 'currency', isCalculated: true },
      ...
      { rowKey: 'total_current_liabilities', label: 'Total Current Liabilities', valueType: 'currency', isCalculated: true },
      { rowKey: 'lt_debt_net', label: 'Long-Term Debt, Net of Current', valueType: 'currency', isCalculated: false },
      { rowKey: 'total_liabilities', label: 'Total Liabilities', valueType: 'currency', isCalculated: true },
      ...
      { rowKey: 'total_equity', label: "Total Stockholders' Equity", valueType: 'currency', isCalculated: true },
      { rowKey: 'total_liabilities_equity', label: 'Total Liabilities & Equity', valueType: 'currency', isCalculated: true },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    // Generic rank-ordered row keys — Gemini populates display_value with actual names.
    // Extract the top products/channels by revenue, ranked 1 (highest) to 10.
    requiredRows: [
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    requiredRows: [
      ...
      { rowKey: 'net_profit', label: 'Net Profit', valueType: 'currency', isCalculated: true },
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    requiredRows: [
      ...
      { rowKey: 'variance', label: 'Variance', valueType: 'currency', isCalculated: true },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    requiredRows: [
      ...
      { rowKey: 'wc_adjusted_nwc', label: 'Adjusted Net Working Capital', valueType: 'currency', isCalculated: true },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    // Generic rank-ordered row keys — Gemini populates display_value with actual vendor names.
    // Extract the top vendors by total spend, ranked 1 (highest) to 8.
    requiredRows: [
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    requiredRows: [
      ...
      { rowKey: 'total_error', label: 'Total Error', valueType: 'currency', isCalculated: true },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    requiredRows: [
      ...
      { rowKey: 'total_revenue', label: 'Total Revenue', valueType: 'currency', isCalculated: true, formula: 'customer_1+customer_2+customer_3+customer_4+customer_5+customer_6+customer_7+customer_8+customer_9+customer_10+all_other_customers' },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    requiredRows: [
      ...
      { rowKey: 'fcf_to_ebitda_ratio', label: 'FCF / EBITDA Conversion', valueType: 'percent', isCalculated: true, formula: 'free_cash_flow/ebitda' },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────
  {
    ...
    requiredRows: [
      ...
      { rowKey: 'pct_variance_gl_tax', label: '% Variance GL vs. Tax', valueType: 'percent', isCalculated: true, formula: 'variance_gl_vs_tax/gl_revenue' },
    ],
  },
